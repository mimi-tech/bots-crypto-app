...
class SelectedCoinChart extends StatefulWidget {
  SelectedCoinChart({@required this.title});
  final String title;
  @override
  _SelectedCoinChartState createState() => _SelectedCoinChartState();
}

class _SelectedCoinChartState extends State<SelectedCoinChart> {
